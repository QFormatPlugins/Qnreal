#ifndef PALETTE_LMP_H
#define PALETTE_LMP_H

static const unsigned char default_palette_lmp[] = {
...
static const int default_palette_size = sizeof(default_palette_lmp) / sizeof(default_palette_lmp[0]);
