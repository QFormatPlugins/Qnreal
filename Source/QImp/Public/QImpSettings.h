...
#include "QImpSettings.generated.h"
...
struct QIMP_API FQuakeMapAssetOptions
{
	GENERATED_BODY()
...
USTRUCT(Blueprintable)
struct QIMP_API FQuakeWadAssetOptions
{
	GENERATED_BODY()
...
UCLASS(Config=QImpEditorSettings)
class QIMP_API UQImpSettings : public UObject
{
	GENERATED_BODY()

public:
	UQImpSettings(const FObjectInitializer& Obj) {}
...
inline void UQImpSettings::Serialize(FArchive& Ar)
{
	Ar << bIsInitialized;
