...
struct FEntity
{
	...
	TEnumAsByte<EEntityType> Type = EntityType_Point;
	UPROPERTY(EditAnywhere)
	FString UniqueClassName = "";
	UPROPERTY(VisibleAnywhere)
	FString ClassName = "";
	UPROPERTY(VisibleAnywhere)
	FVector3d Origin {};
	...
	UPROPERTY(VisibleAnywhere)
	TSubclassOf<AActor> ClassTemplate = nullptr;
};
...
UCLASS()
class QNREAL_API UQuakeMapData : public UObject
{
	GENERATED_BODY()
public:
	UPROPERTY(VisibleAnywhere)
	FSolidEntity WorldSpawn;
